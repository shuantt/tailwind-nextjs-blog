...
const projectsData: Project[] = [
  {
    title: 'CiaoCraft!',
    description: `CiaoCraft! 是一個手作課程販售平台 (B2B2C)。專案範圍含 前台網站 (會員管理) 和 商家管理後台。此作品為六角《 Node.js 前後端產品入門班 》之團體作品。`,
  ...
  {
    title: 'XSpace',
    description: `XSpace 是一個共享場地租借平台 (B2B2C)，具有完整租借方場地上架、管理，及出租方的預訂管理功能。範圍包含 前台網站 (買家、賣家管理) 和 平台方管理後台。此為 Build School 培訓課程之結業作品。`,
